...
try {
   ...
   $callRequest = @{jsonrpc="2.0";id=3;method="tools/call";params=@{name="getRuntimeInfo";arguments=@{}}} | ConvertTo-Json -Depth 8
   ...
   Write-Output "LSP_CLAW_TEST_PASS tools=$($tools.Count) runtime=Mako sessionDeleted=true"
}
finally {
